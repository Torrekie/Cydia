...
CYDIA_BSD_BIN=${CYDIA_PREFIX}/bin
CYDIA_SBIN=${CYDIA_PREFIX}/usr/sbin
CYDIA_BSD_SBIN=${CYDIA_PREFIX}/sbin
...
CYDIA_BOOTSTRAP_PATH=${CYDIA_BSD_BIN}:${CYDIA_BIN}:${CYDIA_BSD_SBIN}:${CYDIA_SBIN}:/bin:/usr/bin:/sbin:/usr/sbin

export CYDIA_PREFIX CYDIA_BIN CYDIA_BSD_BIN CYDIA_SBIN CYDIA_BSD_SBIN
export CYDIA_LIBEXEC CYDIA_STATE CYDIA_BOOTSTRAP_PATH
